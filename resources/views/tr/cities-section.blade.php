<div class="cities-section section">
  <div class="cities-section-content">
    <div class="container-xl">
      <div class="row">
        <div class="col-md-4">
          <div class="section-title _anim-items _anim-no-hide">FARKLI ŞEHİRLERDEKİ<br><span class="accentcolor">SERGİLERİN <br>AFİŞİ</span></div>
          <div class="cities-section-description">İşte etkinliklerimizin düzenli katılımcıları. Tüm katılımcıları görüntülemek için aşağıdaki bağlantıyı takip edin.</div>
          <div class="cities-section-see-all">
            <a href="/tr/poster">Tüm şehirlerin posterini görüntüleyin</a>
          </div>
        </div>
        <div class="col-md-8">
          <div class="cities">
            ...
            <div class="cities-item-wrapper hidden-mobile">
              <div class="cities-item cities-item-right baku">
                <div class="cities-item-content">
                  ...
                  <a href="#" class="cities-item-date">Yakında <br>sinemalarda</a>
                </div>
                <div class="cities-item-circle">
                  <div class="cities-item-image">
